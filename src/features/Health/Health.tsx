...
const KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpqeXJpbGxwZW5ueG93bnR3ZWJvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MjQzNDA4MiwiZXhwIjoyMDg4MDEwMDgyfQ.qs_YCiL_rfyVVNl2jHyFGDi9lhafOXXSnXjYtogUmXY'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '480px' }}>
              {!editingGoals ? (
                ...
                <div style={cardStyle}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div>
                      <label style={{ fontSize: '0.75rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>WEEKLY WORKOUT TARGET</label>
                    ...
                    <div>
                      <label style={{ fontSize: '0.75rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>WEIGHT GOAL (KG)</label>
                    ...
                    <div>
                      <label style={{ fontSize: '0.75rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>NOTES / MOTIVATION</label>
      ...
      {showWorkoutModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ background: '#080c14', border: '1px solid #1a1a24', borderRadius: '16px', padding: '2rem', width: '100%', maxWidth: '420px', margin: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div>
                <label style={{ fontSize: '0.75rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>ACTIVITY</label>
              ...
              <div>
                <label style={{ fontSize: '0.75rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>DURATION (MINUTES)</label>
                <input type="number" style={inputStyle} value={wDuration} onChange={e => setWDuration(e.target.value)} placeholder="e.g. 45" min={1} />
              </div>
              <div>
                <label style={{ fontSize: '0.75rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>NOTES (OPTIONAL)</label>
          ...
          <div style={{ background: '#080c14', border: '1px solid #1a1a24', borderRadius: '16px', padding: '2rem', width: '100%', maxWidth: '420px', margin: '1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              {[['CHEST (CM)', 'chest_cm'], ['WAIST (CM)', 'waist_cm'], ['HIPS (CM)', 'hips_cm'], ['ARMS (CM)', 'arms_cm'], ['LEGS (CM)', 'legs_cm'], ['BODY FAT (%)', 'body_fat_pct']].map(([label, key]) => (
                <div key={key}>
                  <label style={{ fontSize: '0.7rem', color: '#666', display: 'block', marginBottom: '0.3rem' }}>{label}</label>
