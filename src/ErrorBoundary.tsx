    ...
    if (this.state.hasError) {
      return (
        <div style={{ padding: '2rem', color: '#fff', background: '#050508', minHeight: '100vh' }}>
          ...
          <button onClick={() => window.location.reload()} style={{ padding: '0.75rem 1.5rem', background: '#00D4AA', color: '#000', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: '600', marginTop: '1rem' }}>
            Reload Page
          </button>
        </div>
      )
